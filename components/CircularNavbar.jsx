  ...
  return(
    <div className={`${font.className}`}>
      <AnimatePresence mode='wait'>
        ...
        className={`${navHover==true? 'lg:bg-col5':'lg:bg-col0'} bg-col0 justify-right lg:text-2xl md:text-md text-yell fixed left-2 lg:rounded-r-3xl rounded-3xl p-4 lg:p-0 mt-2 mb-2 pr-2 top-1/2 -translate-y-1/2 h-fit w-fit transition-all duration-300 border-white lg:pl-2 z-50 ml-8 lg:ml-0 `}>
